...
function Message({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: stopPropagation only — keyboard users do not interact with the wrapper
    // biome-ignore lint/a11y/useKeyWithClickEvents: stopPropagation only — no semantic action triggered
  ...
  return (
    <>
      ...
      <Presence present={open}>
        {/* biome-ignore lint/a11y/noStaticElementInteractions: backdrop overlay — Esc/close button provide the keyboard path */}
        {/* biome-ignore lint/a11y/useKeyWithClickEvents: backdrop overlay — Esc/close button provide the keyboard path */}
        <div
          data-state={open ? "open" : "closed"}
...
export function useAISearchContext() {
  // biome-ignore lint/style/noNonNullAssertion: hook is only called inside <AIProvider>, so Context is guaranteed
  return use(Context)!;
}
