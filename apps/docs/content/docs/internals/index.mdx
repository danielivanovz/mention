...
- `examples/ProseMirror.tsx`: executable rich-editor adapter.
- `src/components/editing.test.tsx`: controlled input and stale-selection checks.
- `e2e/editor.spec.ts`: mention nodes, formatting, block boundaries and history.
