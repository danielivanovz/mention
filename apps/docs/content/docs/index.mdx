...
With Bun, use `bun add @danielivanov/mention@^0.2.0`. These examples require Mention 0.2. The stylesheet is optional; import it once for the default popup and option styles.
